...
if (process.platform === 'win32') {
    ...
    userDataPath = path.join(process.env.HOME, 'Library', 'Application Support', 'umgst');
} else {
...
rl.question('Please enter the 6-digit code shown in the UMGST app: ', (code) => {
    try {
        if (fs.existsSync(filePath)) {
            ...
            console.log(`JWT file not found at ${filePath}. Please log in via UMGST first.`);
        }
    } catch (error) {
